...
EXPECTED_SENSORS = [
    ...
    ("pos_hip_pitch_l", mujoco.mjtSensor.mjSENS_JOINTPOS, 1),
    ("vel_hip_pitch_l", mujoco.mjtSensor.mjSENS_JOINTVEL, 1),
    ...
    ("pos_hip_pitch_r", mujoco.mjtSensor.mjSENS_JOINTPOS, 1),
    ("vel_hip_pitch_r", mujoco.mjtSensor.mjSENS_JOINTVEL, 1),
